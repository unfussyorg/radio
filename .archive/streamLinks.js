const stations = [
	...
	},
	{
		...
		college_image: "https://www.badgerselect.com/assets/images/FAVIcon/android-chrome-256x256.png",
	...
	},
	{
		...
		city: "Columbia",
		state: "MO",
		station_image: "https://upload.wikimedia.org/wikipedia/en/thumb/8/8f/Kcou-logo.jpg/200px-Kcou-logo.jpg",
	...
	},
	{
		...
		city: "Tucson",
		state: "AZ",
		station_image: "https://static.mytuner.mobi/media/tvos_radios/uzkpp2kqse7c.jpg",
		college_image:
	...
	},
	{
		...
		audio_url: "https://cors-proxy.elfsight.com/http://play.impact89fm.org:8000/impact89fm",
	...
	},
	{
		...
		audio_url: "https://cors-proxy.elfsight.com/http://ice64.securenetsystems.net/WPGUFM",
	...
	},
	{
		...
		audio_url: "https://cors-proxy.elfsight.com/http://netcast.kfjc.org/kfjc-128k-mp3",
	...
	},
	{
		...
		call_sign: "WVFS",
		broadcast_frequency: "89.7",
		audio_url: "https://cors-proxy.elfsight.com/http://voice.wvfs.fsu.edu:8000/stream",
	...
	},
	{
		...
		audio_url: "https://cors-proxy.elfsight.com/http://stream.wuog.org:8000/stream",
	...
	},
	{
		...
		audio_url: "https://cors-proxy.elfsight.com/https://streams.wtju.net:8443/wtjx-opus-256.ogg",
	...
	},
	{
		...
		city: "Lexington",
		state: "VA",
		station_image: "https://static.mytuner.mobi/media/tvos_radios/kNFMSSg6QR.png",
		college_image: "https://upload.wikimedia.org/wikipedia/en/a/a8/W%26L_Generals.png",
	...
	},
	{
		...
		audio_url: "https://cors-proxy.elfsight.com/http://floyd.wcbn.org:8000/wcbn-hd.mp3",
	...
	},
	{
		...
		audio_url: "https://cors-proxy.elfsight.com/http://streamer.cci.utk.edu:8000/wutk",
	...
	},
	{
		...
		call_sign: "WKNC",
		broadcast_frequency: "88.1",
		audio_url: "https://cors-proxy.elfsight.com/http://173.193.205.96:7430/stream",
		station_url: "https://wknc.org/",
		college_name: "North Carolina State University",
		public_private: "Public",
		city: "Raleigh",
		state: "NC",
		station_image: "https://storage.googleapis.com/stateless-wknc-org/sites/1/2020/10/wknc881-bow.png",
	...
	},
	{
		...
		audio_url: "https://cors-proxy.elfsight.com/http://icecast.uvm.edu:8005/wruv_fm_128",
	...
	},
	{
		...
		call_sign: "KWVA",
		broadcast_frequency: "88.1",
		audio_url: "https://cors-proxy.elfsight.com/http://kwvaradio.uoregon.edu:8000/stream/2/",
	...
	},
	{
		...
		call_sign: "WHUS",
		broadcast_frequency: "91.7",
		audio_url: "https://cors-proxy.elfsight.com/http://stream.whus.org:8000/whusfm",
	...
	},
	{
		...
		call_sign: "WRPI",
		broadcast_frequency: "91.5",
		audio_url: "https://cors-proxy.elfsight.com/http://icecast1.wrpi.org:8000/mp3-256.mp3",
		station_url: "https://www.wrpi.org/",
		college_name: "Rensselaer Polytechnic Institute",
		public_private: "Private",
		city: "Troy",
		state: "NY",
		station_image: "http://images.radio.orange.com/radios/large_wrpi_915_fm_troy_ny.png",
		college_image:
	...
	},
	{
		...
		call_sign: "KXUA",
		broadcast_frequency: "88.3",
		audio_url: "https://cors-proxy.elfsight.com/http://listen.uark.edu:8830/;?type=http",
	...
	},
	{
		...
		call_sign: "KFSR",
		broadcast_frequency: "90.7",
		audio_url: "https://cors-proxy.elfsight.com/http://129.8.40.34:8000//;;nop.mp3",
	...
	},
	{
		...
		audio_url: "https://cors-proxy.elfsight.com/http://streaming.wrek.org:8000/wrek_live-128kb",
	...
	},
	{
		...
		college_image: "https://www.volleyballbc.org/wp-content/uploads/2018/08/ubc-logo-png-transparent.png",
	...
	},
	{
		...
		call_sign: "WTUL",
		broadcast_frequency: "91.5",
		audio_url: "https://cors-proxy.elfsight.com/http://129.81.156.83:8000/stream",
	...
	},
	{
		...
		college_image: "https://teamcolorcodes.com/wp-content/uploads/2022/06/Emerson-College-Lions-logo-1.png",
	...
	},
	{
		...
		call_sign: "KZSU",
		broadcast_frequency: "90.1",
		audio_url: "https://cors-proxy.elfsight.com/http://kzsu-streams.stanford.edu/kzsu-1-128.mp3",
		station_url: "http://kzsu.stanford.edu/",
		college_name: "Stanford University",
		public_private: "Private",
		city: "Stanford",
		state: "CA",
		station_image: "https://static.mytuner.mobi/media/tvos_radios/JvbcgbfZAj.png",
	...
	},
	{
		...
		call_sign: "KTCU",
		broadcast_frequency: "88.7",
		audio_url: "https://cors-proxy.elfsight.com/http://ktcustream01.is.tcu.edu/ktcu",
	...
	},
	{
		...
		college_image: "http://www.uottawa.ca/brand/sites/www.uottawa.ca.brand/files/uottawa_ver_black.png",
	...
	},
	{
		...
		call_sign: "WUML",
		broadcast_frequency: "91.5",
		audio_url: "https://cors-proxy.elfsight.com/http://cp12.shoutcheap.com:8306/stream",
	...
	},
	{
		...
		audio_url: "https://cors-proxy.elfsight.com/http://kure-network.stuorg.iastate.edu:8000/KUREBroadcast",
	...
	},
	{
		...
		call_sign: "WVUD",
		broadcast_frequency: "91.3",
		audio_url: "https://cors-proxy.elfsight.com/http://128.175.76.123:8000/stream/1/",
	...
	},
	{
		...
		call_sign: "WNSB",
		broadcast_frequency: "91.1",
		audio_url: "https://cors-proxy.elfsight.com/http://27033.live.streamtheworld.com:3690/WNSBFM.mp3",
	...
	},
	{
		...
		call_sign: "WRAS",
		broadcast_frequency: "88.5",
		audio_url: "https://cors-proxy.elfsight.com/http://22113.live.streamtheworld.com/WRASFM_SC",
		station_url: "https://wras.org/",
		college_name: "Georgia State University",
		public_private: "Public",
		city: "Atlanta",
		state: "GA",
		station_image: "https://upload.wikimedia.org/wikipedia/en/a/ae/WRAS_Logo.png",
	...
	},
	{
		...
		call_sign: "KRUI",
		broadcast_frequency: "89.7",
		audio_url: "https://cors-proxy.elfsight.com/http://krui.student-services.uiowa.edu:8000/listen",
	...
	},
	{
		...
		audio_url: "https://cors-proxy.elfsight.com/http://radiokstreams.cce.umn.edu:8256/;?type=http",
	...
	},
	{
		...
		audio_url: "https://cors-proxy.elfsight.com/http://audio.wpts.pitt.edu:8000/wpts_live_128s.mp3",
		station_url: "https://wptsradio.org/",
		college_name: "University of Pittsburgh",
		public_private: "Public",
		city: "Pittsburgh",
		state: "PA",
		station_image: "https://wptsradio.org/wp-content/uploads/2015/12/WPTS-Square-Logo.png",
		college_image:
	...
	},
	{
		...
		call_sign: "WMFO",
		broadcast_frequency: "91.5",
		audio_url: "https://cors-proxy.elfsight.com/http://webstream.wmfo.org/;?type=http",
		...
		college_image: "https://upload.wikimedia.org/wikipedia/en/2/22/Tufts_Jumbos_logo.png",
	...
	},
	{
		...
		call_sign: "KRLX",
		broadcast_frequency: "88.1",
		audio_url: "https://cors-proxy.elfsight.com/http://137.22.31.174:8000/stream",
	...
	},
	{
		...
		call_sign: "WUNH",
		broadcast_frequency: "91.3",
		audio_url: "https://cors-proxy.elfsight.com/http://s9.viastreaming.net:9000/;",
	...
	},
	{
		...
		call_sign: "WZBC",
		broadcast_frequency: "90.3",
		audio_url: "https://cors-proxy.elfsight.com/http://amber.streamguys.com:4860/;stream/1",
	...
	},
	{
		...
		call_sign: "WIUP",
		broadcast_frequency: "90.1",
		audio_url: "https://cors-proxy.elfsight.com/http://144.80.16.164:8000/xstream",
	...
	},
	{
		...
		city: "Windham",
		state: "CT",
		station_image: "https://static.mytuner.mobi/media/tvos_radios/2pgzAUzUzC.png",
		college_image:
	...
	},
	{
		...
		call_sign: "WBER",
		broadcast_frequency: "90.5",
		audio_url: "https://cors-proxy.elfsight.com/http://wber-ice-encoder.monroe.edu/wber-high.mp3",
	...
	},
	{
		...
		call_sign: "WSTB",
		broadcast_frequency: "88.9",
		audio_url: "https://cors-proxy.elfsight.com/http://peridot.streamguys.com:5550/live",
	...
	},
	{
		...
		call_sign: "KAOS",
		broadcast_frequency: "89.3",
		audio_url: "https://cors-proxy.elfsight.com/http://www.golden-apple.com:8930/;",
		...
		college_image: "https://www.evergreen.edu/sites/default/files/primary-logo-sample.png",
	...
	},
	{
		...
		city: "Boston",
		state: "MA",
		station_image: "https://wrbbradio.org/wp-content/uploads/2013/11/wrbb_retro-1024x999.jpeg",
	...
	},
	{
		...
		city: "Rochester",
		state: "NY",
		station_image: "https://upload.wikimedia.org/wikipedia/en/2/2a/WITR_logo_2022.jpg",
	...
	},
	{
		...
		college_image: "https://www.theharlemvalleynews.net/wp-content/uploads/2021/12/milw.png",
	...
	},
	{
		...
		college_image: "https://upload.wikimedia.org/wikipedia/en/a/ae/Wisconsin%E2%80%93Whitewater_Warhawks_Logo.png",
	...
	},
	{
		...
		call_sign: "KDUR",
		broadcast_frequency: "91.9",
		audio_url: "https://cors-proxy.elfsight.com/http://kdurradio.fortlewis.edu/stream",
	...
	},
	{
		...
		audio_url: "https://cors-proxy.elfsight.com/http://icecast.commedia.org.uk:8000/ucaradio.mp3",
	...
	},
	{
		...
		city: "Vila Real",
		state: "Portugal",
		station_image: "http://www.universidade.fm/wp-content/uploads/2018/10/UFM_quadrado.png",
		college_image:
	...
	},
	{
		...
		city: "Lisbon",
		state: "Portugal",
		station_image: "https://static.mytuner.mobi/media/tvos_radios/gs8fzckgerrp.png",
		college_image: "https://grupoceu.pt/wp-content/uploads/2020/10/ual-logo.png",
	...
	},
	{
		...
		call_sign: "WCFM",
		broadcast_frequency: "91.9",
		audio_url: "https://cors-proxy.elfsight.com/http://137.165.206.193:8000/stream?",
		station_url: "https://sites.williams.edu/wcfm/",
		college_name: "Williams College",
		public_private: "Private",
		city: "Williamstown",
		state: "MA",
		station_image: "https://static.mytuner.mobi/media/tvos_radios/X7VgKdWDCV.png",
	...
	},
	{
		...
		college_image: "https://oeh-fhcw.at/wp-content/uploads/2021/12/cropped-oeh-fh-campus-wien.png",
	...
	},
	{
		...
		audio_url: "https://cors-proxy.elfsight.com/http://www.radiocampusparis.org:8000/stream_rcp",
	...
	},
	{
		...
		call_sign: "WRCT",
		broadcast_frequency: "88.3",
		audio_url: "https://cors-proxy.elfsight.com/http://stream.wrct.org:8000/wrct-hi.mp3",
